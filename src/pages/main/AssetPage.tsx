    ...
    <S.Container>
      ...
      <S.Card>
        <S.GoalHeader>
          ...
          <S.SettingButton onClick={() => navigate("/asset/1")}>
            설정하기
          </S.SettingButton>
        </S.GoalHeader>
        ...
        <S.GoalDetail>
          <div>
            인증 금액 <strong>{data.receiptFiPoint}원</strong>
          </div>
          <div>
            목표까지 남은 금액 <strong>{data.leftPoint}원</strong>
          </div>
        </S.GoalDetail>
      </S.Card>
      ...
      <S.Card>
        ...
        <S.HoldingValue>
          <div>
            보유 <strong>{data.fiPoint}원</strong>
          </div>
        </S.HoldingValue>
        <S.DepositButton onClick={() => navigate("/asset/account/1")}>
          입금하기
        </S.DepositButton>
      </S.Card>
    </S.Container>
